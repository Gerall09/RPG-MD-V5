...
`, text.trim(), flaa, [
    ...
    ], m, { 'document':{'url':'https://telegra.ph/file/ac2ff180b8b620b075cfd.jpg'},
'mimetype':global.dpdf,
'fileName':'「 ᴹᴿ᭄ Rall ×፝֟͜× 」',
'fileLength':fsizedoc,
'pageCount':fpagedoc,
'previewType':'pdf',
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        sourceUrl: 'https://youtu.be/05H1N5FwpyE',
                        mediaType: 2,
                        description: `⚘ ᴄʀᴇᴀᴛᴇ ᴹᴿ᭄ Rall ×፝֟͜×`,
                        title: `💌 My Ultah: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `⚘ by ᴹᴿ᭄ Rall ×፝֟͜×`,          previewType: 0,
                        thumbnail: await (await fetch(thumb)).buffer(),
                        mediaUrl: 'https://youtu.be/05H1N5FwpyE'
